...
```{r, echo=FALSE}
knitr::include_graphics("../images/nba-finals-2015.jpg")
```
...
```{r, echo=FALSE}
kable(two_pt_shot_chart, caption= "2PT Effective Shooting by Player")
```

**Effective Shooting % by Player** 

```{r, echo=FALSE}
kable(effective_shot_chart, caption="Effective Shooting by Player")
```
...
```{r, echo=FALSE}
kable(three_pt_shot_chart, caption="3PT Effective Shooting by Player")
```
